...
def test_without_a_shared_pool_the_group_still_joins(evaluation, monkeypatch):
    """The group owns the pool and the frames, so nothing else can wait for the encoders."""
    ev, encoded = evaluation
    _with_pool(ev, monkeypatch)
