    ...
    Workflow(
        ...
        args=[
            ...
            ArgSpec(
                "end",
                "int",
                label="End route frame (0 = start + route frames)",
                default=0,
            ),
            ArgSpec("steps", "int", label="Route frames when end=0", default=120),
            ArgSpec("max_steps", "int", label="Max sim/render frames (0 = route frames)", default=0),
            ArgSpec(
                "goal_reach_m",
                "float",
                label="Early goal stop distance (m; 0 = off)",
                default=0.0,
            ),
