    ...
    evaluator = FullRouteClosedLoopEvaluation(
        ...
        ClosedLoopEvalConfig(
            ...
            params=RolloutParams(
                ...
                accel_dead_time_s=cfg.closed_loop_accel_dead_time_s,
                accel_time_constant_s=cfg.closed_loop_accel_time_constant_s,
                controller_compensation=cfg.closed_loop_controller_compensation,
            ),
