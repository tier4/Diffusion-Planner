...
class TrainConfig:
    ...
    seed: int = 3407
    train_epochs: int = 80
    batch_size: int = cli("batch size", default=4096)
    save_utd: int = 10
    ...
    # cost scales as depth * mixer dims, not as hidden_dim. 32/32/1 mirrors the
    # new-architecture branch; 128/64/6 is what runs before this change.
