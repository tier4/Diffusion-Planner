...
TURN_INDICATOR_LOGIT_SHAPE = (1, 4)
...
LANES_SHAPE = (1, NUM_SEGMENTS_IN_LANE, POINTS_PER_SEGMENT, SEGMENT_POINT_DIM)
LANES_HAS_SPEED_LIMIT_SHAPE = (1, NUM_SEGMENTS_IN_LANE, 1)
LANES_SPEED_LIMIT_SHAPE = (1, NUM_SEGMENTS_IN_LANE, 1)
ROUTE_LANES_SHAPE = (1, NUM_SEGMENTS_IN_ROUTE, POINTS_PER_SEGMENT, SEGMENT_POINT_DIM)
