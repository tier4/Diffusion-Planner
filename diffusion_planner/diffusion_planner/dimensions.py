...
EGO_AGENT_PAST_IDX_TIMESTAMP = 4
...
EGO_HISTORY_DIM = POSE_DIM + 1  # x, y, cos(yaw), sin(yaw), timestamp
...
EGO_HISTORY_SHAPE = (1, INPUT_T + 1, EGO_HISTORY_DIM)
EGO_CURRENT_STATE_SHAPE = (1, 10)
NEIGHBOR_SHAPE = (1, MAX_NUM_NEIGHBORS, INPUT_T + 1, 12)
