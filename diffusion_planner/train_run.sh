...
TRAIN_SET_LIST="/mnt/nvme3/sakoda/nas_copy/private_workspace/diffusion_planner/preprocessed_ver57_realdata/path_list_train_with_psim_data.json"
VALID_SET_LIST="/mnt/nvme3/sakoda/nas_copy/private_workspace/diffusion_planner/preprocessed_ver57_realdata/path_list_valid.json"
