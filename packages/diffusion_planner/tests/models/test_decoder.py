...
class TrajectoryDecoderTest(unittest.TestCase):
    def test_preserves_trajectory_shape_and_backpropagates(self) -> None:
        ...
        x = torch.randn(2, TRAJECTORY_LENGTH, TRAJECTORY_DIM, requires_grad=True)
    ...
    def test_accepts_column_flow_time(self) -> None:
        ...
        output = decoder(
            torch.zeros(1, TRAJECTORY_LENGTH, TRAJECTORY_DIM),
            torch.ones(1, 3, 8),
        ...
        self.assertEqual(output.shape, (1, TRAJECTORY_LENGTH, TRAJECTORY_DIM))
